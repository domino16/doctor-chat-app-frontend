...
export const addChatId = createAction('[CHAT PAGE] add Chat Id', props<{chatId:number}>())
...
export const loadMessagesStart = createAction('[CHAT PAGE] load messages start', props<{chatId: number}>())
